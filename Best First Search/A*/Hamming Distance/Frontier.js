...
var frontier = {
	...
	swim : function(k) {
        ...
        while (child > 1)
        {
			...
			if (this.MinPQ[child].evalFunctionValue > this.MinPQ[parent].evalFunctionValue) {
				break;
			}
	...
	sink : function(k) {
        ...
        { 
            ...
            if (child < this.N && (this.MinPQ[child + 1].evalFunctionValue < this.MinPQ[child].evalFunctionValue)) child++;
            ...
            if (this.MinPQ[parent].evalFunctionValue < this.MinPQ[child].evalFunctionValue) break;
            this.promote(child, parent);
