// A* with consistent heuristic function -> optimal implementation
...
function makeNode(currentBoard, previousBoard, costSoFar) {
	...
	return newNode = {
		        ...
		        prevBoard : previousBoard,
		             cost : costSoFar,
		        heuristic : computeManhattanDistance(currentBoard),
		evalFunctionValue : computeManhattanDistance(currentBoard) + costSoFar	
	};
}
